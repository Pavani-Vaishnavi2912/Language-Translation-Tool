...
label = CTkLabel(master=app, text="A TRANSLATOR TOOL", font=font1, text_color="#ffffff")
label.place(relx=0.5, rely=0.05, anchor="center")
label2 = CTkLabel(master=app, text="Choose a language to Translate", font=("Eras Bold ITC", 10), text_color="#ffffff")
...
label = CTkLabel(master=app, text="Created By Pavani Vaishnavi", font=("Eras Bold ITC", 10), text_color="#ffffff")
